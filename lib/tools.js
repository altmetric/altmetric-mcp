        ...
        inputSchema: {
          ...
          properties: {
            ...
            mention_types: {
              ...
              description: 'Only return sources of these types, e.g. ["msm"] for news outlets or ["bluesky"] for Bluesky accounts. Note the API\'s names: news is "msm", Reddit is "rdt", Facebook is "fbwall". Patents, Wikipedia, F1000, Q&A, video and Pinterest have no source profiles and cannot be filtered here.',
            },
            include_related: {
              type: 'boolean',
