...
const EXPLORER_OUTPUT_SCHEMA = {
  ...
  properties: {
    data: { type: 'array', description: 'The records for this page.' },
    meta: { type: 'object', description: 'Response metadata, including total-results and total-pages.' },
    links: { type: 'object' },
    included: { type: 'array', description: 'Related objects, present only when include_related is set.' },
  },
